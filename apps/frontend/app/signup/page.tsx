        ...
        >
          ...
          <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-xl relative z-10">
            ...
            <div className="text-center mb-8">
              <h1 className="font-display text-3xl text-gray-900 font-bold mb-2">Create your account</h1>
              <p className="text-gray-600 font-body">
                Start sketching your ideas for free
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label htmlFor="name" className="block font-body font-medium text-gray-900">
                  Full Name
                </label>
              ...
              <div className="flex items-start gap-3">
                <button
                  ...
                  className={`w-5 h-5 mt-0.5 rounded border-2 border-gray-200 flex items-center justify-center transition-all ${
                    agreedToTerms ? "bg-orange-500 border-orange-500" : "bg-white"
                  }`}
                >
                  {agreedToTerms && <Check className="w-3 h-3 text-white" />}
                </button>
                <label className="text-sm text-gray-600 font-body">
                  I agree to the{" "}
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="text-gray-500 font-body text-sm">or sign up with</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
            ...
            <p className="text-center mt-8 text-gray-600 font-body">
              ...
              <Link href="/signin" className="text-orange-500 hover:text-orange-600 hover:underline font-semibold">
                Sign in
              </Link>
            </p>
          </div>
